...
public class PlayerStatus implements Serializable{
	...
	//称谓$
	public String title = "≮无名氏≯";
	//人气
	public int popularity = 800;
	//帮派
	public String faction = "无";
	//门派
	public String school = "无";
	//帮派贡献
    ...
    //TODO 身上的物品
    public ItemInstance[] items = new ItemInstance[40];
	...
	public PlayerStatus(String id, String name, String character) {
		this.id = id;
		this.name = name;
	 ...
	 * @param data
	 */
	public PlayerStatus(PlayerStatus data) {
		this.id = data.id;
		this.name = data.name;
	...
	public void setShun(int value) {
		this.shun = value;
	}
	public int getWakan() {
		return wakan;
	}
	public void setWakan(int value) {
		this.wakan = value;
	}
	public int getTmpHitrate() {
		return tmpHitrate;
	}
	public void setTmpHitrate(int value) {
		this.tmpHitrate = value;
	}
	public int getTmpHarm() {
		return tmpHarm;
	}
	public void setTmpHarm(int value) {
		this.tmpHarm = value;
	}
	public int getTmpDefense() {
		return tmpDefense;
	}
	public void setTmpDefense(int value) {
		this.tmpDefense = value;
	}
	public int getTmpSpeed() {
		return tmpSpeed;
	}
	public void setTmpSpeed(int value) {
		this.tmpSpeed = value;
	}
	public int getTmpShun() {
		return tmpShun;
	}
	public void setTmpShun(int value) {
		this.tmpShun = value;
	}
	public int getTmpWakan() {
		return tmpWakan;
	}
	public void setTmpWakan(int value) {
		this.tmpWakan = value;
	}
	...
	public void setFactionContribution(int value) {
		this.factionContribution = value;
	}
	public int getSchoolContribution() {
		return schoolContribution;
	}
	public void setSchoolContribution(int value) {
		this.schoolContribution = value;
	}
